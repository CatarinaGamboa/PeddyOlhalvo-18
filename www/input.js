...
var  nomesPerc = ['Largo','Tristão','Villar'];
/******************************Inicio Perc 1 *******************************/
var listasPergPercurso1 = [ 
	...
	new Array (new PergResposta(new Pergunta(161, 'Descobre a palavra: 4ª linha, 3, 12, 17'), 'luz'),//6
			   new PergResposta(new Pergunta(162, 'Descobre a palavra: 7ª linha, 4, 9, 13, 16'), 'amor'),
			   new PergResposta(new Pergunta(163, 'Descobre a palavra: 9ª linha, 3, 7, 21, 27, 28'), 'maria'),
			   new PergResposta(new Pergunta(161, 'Descobre a palavra: 7ª linha, 14, 16, 17, 21, 28'), 'credo')),
...
var listasPergPercurso2 = [ 
	...
	new Array (new PergResposta(new Pergunta(291, 'O que está entre o Jantar Bonito no chão?'), 'H'),//9
			   new PergResposta(new Pergunta(292, 'O que está depois do Jantar de Hoje no chão?'), 'B'),
			   new PergResposta(new Pergunta(293, 'Quantas pás tem a ventoinha acima do H no chão?'), '8')),
	...
	new Array (new PergResposta(new Pergunta(2111, 'Que ave está no 44?'), 'andorinha'),//11
			   ...
			   new PergResposta(new Pergunta(2113, 'Quais as 2 primeiras letras do apelido do dono do atelier?'), 'Ca')),
...
var listaIndicacoesPercurso2 = ['Aproxime-se do losango no ar',//1
								...
								'No final das escadas, olha para o céu Português',//4
								'Continua a descer','',//5,6
								'No fim do Tristão vira a direita','', '', '', '',//7-11
								'Sobe a rua das Adegas', '', '', //12-14
								'No fim da subida aproxime-se dos bombeiros', //15
...
var listasPergPercurso3 = [ 
	...
	new Array (new PergResposta(new Pergunta(361, 'Qual a bebida mais fresca?'), 'limonada')),//6------------------REVER
...
var listaIndicacoesPercurso3 = ['Desça as escadas à direita',//1
 								'Contorne a SFO e suba do lado direito','',//2,3
 								...
 								'No fim do frei vira à direita', 'Depois do 3',//11,12
 								...
 								'Segue até à "Azul e Rosa" e segue a direção do 18', 'Segue pelo beco', ''];//18, 19, 20
 								

/***************************Fim Perc 3 ************************/
/****************************Desporto************************************/
var atividadesDesp = ['Volei', 'Corda', 'Raquetes'];
var descDesp = ['Aqui têm de fazer o máximo número de passes consecutivos que conseguirem em 5 minutos',
				'Nesta etapa cada um tem a hipotese de fazer o máximo número de saltos consecutivos. Têm 5 minutos e no final acumula aos pontos o maior número conseguido',
				'Nesta parte têm de escolher dois elementos do grupo para jogar raquetes e fazer o maior número de passes que conseguirem em 5 minutos',
				];